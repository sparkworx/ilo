...
PROMPT
PROMPT This script executes without prompt, for silent installs. One argument is
PROMPT expected, the schema owner for ILO objects. The script should be executed 
PROMPT while connected to the SYS account with SYSDBA privileges. The ILO schema
PROMPT owner must have already been created. The script ilo_create_user.sql may
PROMPT be used for this purpose.
PROMPT
...
PROMPT Using argument 1: &1 as schema owner of ILO packages

set echo off heading off termout off feedback off
rem create the h_user subst variable
column tempuser new_value h_user
select '&1' tempuser from dual;
...
PROMPT
PROMPT =================================================================================
PROMPT Installation of ILO SYS install complete. 
PROMPT Now login as &&h_user and execute ilo_install_silent_user.sql 
PROMPT =================================================================================
spool off
exit
